...
public class Class182 {
    ...
    static void method1200(InterfaceComponent var0, int var1, int var2, int var3) {
        ...
        if (var4 != null) {
            DrawingArea.clip(var1, var2, var1 + var4.anInt204, var2 + var4.anInt209);
            if (Client.anInt1698 != 2 && Client.anInt1698 != 5) {
                int var5 = Client.mapRotation + Client.mapScale & 2047;
                int var6 = Client.playerEntity.strictX / 32 + 48;
                int var7 = 464 - Client.playerEntity.strictY / 32;
                ...
                for (var8 = 0; var8 < Client.anInt1693; ++var8) {
                    var9 = Client.anIntArray1696[var8] * 4 + 2 - Client.playerEntity.strictX / 32;
                    var10 = Client.anIntArray1700[var8] * 4 + 2 - Client.playerEntity.strictY / 32;
                ...
                for (var8 = 0; var8 < 104; ++var8) {
                    for (var9 = 0; var9 < 104; ++var9) {
                        NodeDeque var11 = Client.pickableNodes[PlayerEntity.floorLevel][var8][var9];
                        if (var11 != null) {
                            var12 = var8 * 4 + 2 - Client.playerEntity.strictX / 32;
                            var13 = var9 * 4 + 2 - Client.playerEntity.strictY / 32;
                ...
                for (var8 = 0; var8 < Client.anInt1501; ++var8) {
                    NpcEntity var14 = Client.npcEntities[Client.npcIndices[var8]];
                    if (var14 != null && var14.method194()) {
                        ...
                        if (var20 != null && var20.aBoolean215 && var20.aBoolean2014) {
                            var12 = var14.strictX / 32 - Client.playerEntity.strictX / 32;
                            var13 = var14.strictY / 32 - Client.playerEntity.strictY / 32;
                ...
                for (var10 = 0; var10 < var8; ++var10) {
                    PlayerEntity var15 = Client.playerEntities[var23[var10]];
                    if (var15 != null && var15.method194() && !var15.aBoolean215 && Client.playerEntity != var15) {
                        var13 = var15.strictX / 32 - Client.playerEntity.strictX / 32;
                        int var16 = var15.strictY / 32 - Client.playerEntity.strictY / 32;
                        boolean var17 = false;
                        ...
                        boolean var24 = false;
                        if (Client.playerEntity.anInt219 != 0 && var15.anInt219 != 0 && var15.anInt219 == Client.playerEntity.anInt219) {
                            var24 = true;
                        }
                ...
                if (Client.anInt1485 != 0 && Client.engineCycle % 20 < 10) {
                    if (Client.anInt1485 == 1 && Client.hintArrowNpcIndex >= 0 && Client.hintArrowNpcIndex < Client.npcEntities.length) {
                        NpcEntity var21 = Client.npcEntities[Client.hintArrowNpcIndex];
                        if (var21 != null) {
                            var12 = var21.strictX / 32 - Client.playerEntity.strictX / 32;
                            var13 = var21.strictY / 32 - Client.playerEntity.strictY / 32;
                            Class18.method139(var1, var2, var12, var13, Class54.aSpriteArray419[1], var4);
                        }
                    }

                    if (Client.anInt1485 == 2) {
                        var10 = Client.hintArrowX * 4 - Class62.anInt636 * 4 + 2 - Client.playerEntity.strictX / 32;
                        var12 = Client.hintArrowY * 4 - Class49.anInt377 * 4 + 2 - Client.playerEntity.strictY / 32;
                        Class18.method139(var1, var2, var10, var12, Class54.aSpriteArray419[1], var4);
                    }

                    if (Client.anInt1485 == 10 && Client.anInt1472 >= 0 && Client.anInt1472 < Client.playerEntities.length) {
                        PlayerEntity var22 = Client.playerEntities[Client.anInt1472];
                        if (var22 != null) {
                            var12 = var22.strictX / 32 - Client.playerEntity.strictX / 32;
                            var13 = var22.strictY / 32 - Client.playerEntity.strictY / 32;
                            Class18.method139(var1, var2, var12, var13, Class54.aSpriteArray419[1], var4);
                        }
                    }
                }
                ...
                if (Client.destinationX != 0) {
                    var10 = Client.destinationX * 4 + 2 - Client.playerEntity.strictX / 32;
                    var12 = Client.destinationY * 4 + 2 - Client.playerEntity.strictY / 32;
                    Node_Sub7.method334(var1, var2, var10, var12, Class54.aSpriteArray419[0], var4);
                }

                if (!Client.playerEntity.aBoolean215) {
