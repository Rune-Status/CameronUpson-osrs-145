...
public final class CacheIndex {
    ...
    public byte[] method801(int var1) {
        Class93 var2 = aClass93_1354;
        synchronized (aClass93_1354) {
            Object var10000;
            try {
                if (aClass93_1352.method600() < (long) (var1 * 6 + 6)) {
                    var10000 = null;
                    return (byte[]) var10000;
                }

                aClass93_1352.method605((long) (var1 * 6));
                aClass93_1352.method602(aByteArray1350, 0, 6);
                ...
                if (var3 < 0 || var3 > anInt1353) {
                    var10000 = null;
                    return (byte[]) var10000;
                }

                if (var4 > 0 && (long) var4 <= aClass93_1354.method600() / 520L) {
                    ...
                    for (int var7 = 0; var6 < var3; ++var7) {
                        ...
                        aClass93_1354.method605((long) (var4 * 520));
                        int var8 = var3 - var6;
                        if (var8 > 512) {
                            var8 = 512;
                        }

                        aClass93_1354.method602(aByteArray1350, 0, var8 + 8);
                        ...
                        if (var1 != var9 || var7 != var10 || anInt1351 != var12) {
                            var10000 = null;
                            return (byte[]) var10000;
                        }

                        if (var11 < 0 || (long) var11 > aClass93_1354.method600() / 520L) {
                            var10000 = null;
                            return (byte[]) var10000;
                        }
    ...
    public boolean method804(int var1, byte[] var2, int var3) {
        Class93 var4 = aClass93_1354;
        synchronized (aClass93_1354) {
            if (var3 >= 0 && var3 <= anInt1353) {
                boolean var5 = method802(var1, var2, var3, true);
                if (!var5) {
                    var5 = method802(var1, var2, var3, false);
                }
        ...
        synchronized (aClass93_1354) {
            try {
                ...
                if (var4) {
                    ...
                    if (var6 <= 0 || (long) var6 > aClass93_1354.method600() / 520L) {
                        var10000 = false;
                        return var10000;
                    }
                } else {
                    var6 = (int) ((aClass93_1354.method600() + 519L) / 520L);
                    if (var6 == 0) {
                        var6 = 1;
                    }
                }
                ...
                aClass93_1352.method605((long) (var1 * 6));
                aClass93_1352.method604(aByteArray1350, 0, 6);
                int var7 = 0;
                int var8 = 0;
                ...
                while (true) {
                    if (var7 < var3) {
                        label140:
                        {
                            ...
                            int var10;
                            if (var4) {
                                aClass93_1354.method605((long) (var6 * 520));

                                try {
                                    aClass93_1354.method602(aByteArray1350, 0, 8);
                                ...
                                int var12 = aByteArray1350[7] & 255;
                                if (var10 != var1 || var11 != var8 || anInt1351 != var12) {
                                    var10000 = false;
                                    return var10000;
                                }

                                if (var9 < 0 || (long) var9 > aClass93_1354.method600() / 520L) {
                                    var10000 = false;
                                    return var10000;
                                }
                            }
                            ...
                            if (var9 == 0) {
                                var4 = false;
                                var9 = (int) ((aClass93_1354.method600() + 519L) / 520L);
                                if (var9 == 0) {
                                    ++var9;
                                }
                            ...
                            aByteArray1350[7] = (byte) anInt1351;
                            aClass93_1354.method605((long) (var6 * 520));
                            aClass93_1354.method604(aByteArray1350, 0, 8);
                            var10 = var3 - var7;
                            if (var10 > 512) {
                                var10 = 512;
                            }

                            aClass93_1354.method604(var2, var7, var10);
                            var7 += var10;
                            var6 = var9;
                            ++var8;
                            continue;
