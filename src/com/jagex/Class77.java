        ...
        if (Client.anInt1492 == 0) {
            ...
            if (Client.anInt1492 != 20) {
                if (Client.anInt1492 == 30) {
                    Client.aCacheReferenceTable1493 = GameSocket.method887(0, false, true, true);
                    Client.aCacheReferenceTable1496 = GameSocket.method887(1, false, true, true);
                    Class73.aCacheReferenceTable741 = GameSocket.method887(2, true, false, true);
                    BoundingBox.aCacheReferenceTable372 = GameSocket.method887(3, false, true, true);
                    Class34.aCacheReferenceTable274 = GameSocket.method887(4, false, true, true);
                    Class126.aCacheReferenceTable1368 = GameSocket.method887(5, true, true, true);
                    Class100.aCacheReferenceTable1119 = GameSocket.method887(6, true, true, false);
                    Class76.aCacheReferenceTable823 = GameSocket.method887(7, false, true, true);
                    Class21.aCacheReferenceTable139 = GameSocket.method887(8, false, true, true);
                    Class60.aCacheReferenceTable630 = GameSocket.method887(9, false, true, true);
                    Class82.aCacheReferenceTable848 = GameSocket.method887(10, false, true, true);
                    Applet_Sub1.aCacheReferenceTable681 = GameSocket.method887(11, false, true, true);
                    ScriptEvent.aCacheReferenceTable322 = GameSocket.method887(12, false, true, true);
                    Class2.aCacheReferenceTable8 = GameSocket.method887(13, true, false, true);
                    Class147.aCacheReferenceTable1810 = GameSocket.method887(14, false, true, false);
                    Class119.aCacheReferenceTable1357 = GameSocket.method887(15, false, true, true);
                    Class73.aCacheReferenceTable740 = GameSocket.method887(16, false, true, false);
