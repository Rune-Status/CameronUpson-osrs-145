...
public abstract class Class111 {
    ...
    public static Node_Sub21_Sub13 method770(int var0) {
        Node_Sub21_Sub13 var1 = (Node_Sub21_Sub13) Node_Sub21_Sub13.aReferenceCache2025.get((long) var0);
        if (var1 != null) {
            return var1;
        }
        byte[] var2 = Node_Sub21_Sub13.aReferenceTable2012.unpack(8, var0);
        var1 = new Node_Sub21_Sub13();
        if (var2 != null) {
            var1.method1066(new Buffer(var2));
        }

        Node_Sub21_Sub13.aReferenceCache2025.put(var1, (long) var0);
        return var1;
    }
