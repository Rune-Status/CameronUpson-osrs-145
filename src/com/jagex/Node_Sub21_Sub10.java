...
public class Node_Sub21_Sub10 extends DoublyNode {
    ...
    public static Node_Sub21_Sub12 method1063(int var0) {
        Node_Sub21_Sub12 var1 = (Node_Sub21_Sub12) Node_Sub21_Sub12.aReferenceCache2025.get((long) var0);
        if (var1 != null) {
            return var1;
        }
        byte[] var2 = Node_Sub21_Sub12.aReferenceTable2012.unpack(4, var0);
        ...
        var1.method756();
        Node_Sub21_Sub12.aReferenceCache2025.put(var1, (long) var0);
        return var1;
    }

    public static void method1064(ReferenceTable var0, ReferenceTable var1) {
        NpcDefinition.definitionTable = var0;
