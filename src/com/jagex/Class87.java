...
public class Class87 {
    ...
    static int method511(int[] var0, int var1) {
        int var2 = var0[var1];
        int var3 = -1;
    ...
    int method513(int var1, int var2, int var3, int var4, int var5) {
        int var6 = var4 - var2;
        int var7 = var3 - var1;
    ...
    void method512(int var1, int var2, int var3, int var4, float[] var5, int var6) {
        int var7 = var4 - var2;
        int var8 = var3 - var1;
        ...
        for (int var14 = var1 + 1; var14 < var3; ++var14) {
            ...
            var5[var14] *= aFloatArray911[var11];
        }

    }

    void method514(int var1, int var2) {
        if (var1 < var2) {
            int var3 = var1;
            int var4 = anIntArray903[var1];
            int var5 = anIntArray912[var1];
            boolean var6 = aBooleanArray902[var1];

            for (int var7 = var1 + 1; var7 <= var2; ++var7) {
                int var8 = anIntArray903[var7];
                if (var8 < var4) {
                    anIntArray903[var3] = var8;
                    anIntArray912[var3] = anIntArray912[var7];
                    aBooleanArray902[var3] = aBooleanArray902[var7];
                    ++var3;
                    anIntArray903[var7] = anIntArray903[var3];
                    anIntArray912[var7] = anIntArray912[var3];
                    aBooleanArray902[var7] = aBooleanArray902[var3];
                }
            }

            anIntArray903[var3] = var4;
            anIntArray912[var3] = var5;
            aBooleanArray902[var3] = var6;
            this.method514(var1, var3 - 1);
            this.method514(var3 + 1, var2);
        }
    }
    ...
    void method516(float[] var1, int var2) {
        int var3 = this.anIntArray905.length;
        int var4 = anIntArray901[this.anInt904 - 1];
        boolean[] var5 = aBooleanArray902;
        aBooleanArray902[1] = true;
        var5[0] = true;
        ...
        for (var6 = 2; var6 < var3; ++var6) {
            var7 = method511(anIntArray903, var6);
            var8 = method517(anIntArray903, var6);
            var9 = this.method513(anIntArray903[var7], anIntArray912[var7], anIntArray903[var8], anIntArray912[var8], anIntArray903[var6]);
            var10 = anIntArray912[var6];
            int var11 = var4 - var9;
            int var13 = (var11 < var9 ? var11 : var9) << 1;
            if (var10 != 0) {
                boolean[] var14 = aBooleanArray902;
                aBooleanArray902[var8] = true;
                var14[var7] = true;
                aBooleanArray902[var6] = true;
                if (var10 >= var13) {
                    anIntArray912[var6] = var11 > var9 ? var10 - var9 + var9 : var9 - var10 + var11 - 1;
                } else {
                    anIntArray912[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var9 + var10 / 2;
                }
            } else {
                aBooleanArray902[var6] = false;
                anIntArray912[var6] = var9;
            }
        }

        this.method514(0, var3 - 1);
        var6 = 0;
        var7 = anIntArray912[0] * this.anInt904;

        for (var8 = 1; var8 < var3; ++var8) {
            if (aBooleanArray902[var8]) {
                var9 = anIntArray903[var8];
                var10 = anIntArray912[var8] * this.anInt904;
                this.method512(var6, var7, var9, var10, var1, var2);
                if (var9 >= var2) {
                    return;
                }
        ...
        float var16 = aFloatArray911[var7];
