...
public final class NpcEntity extends PathingEntity {
    ...
    protected final Model getModel() {
        ...
        AnimationSequence var2 = this.anInt768 != -1 && (this.anInt754 != this.anInt768 || var1 == null) ? AnimationSequence.get(this.anInt768) : null;
        ...
        if (this.anInt771 != -1 && this.anInt782 != -1) {
            Model var4 = GraphicDefinition.get(this.anInt771).getModel(this.anInt782);
            if (var4 != null) {
