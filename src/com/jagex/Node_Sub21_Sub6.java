    ...
    static boolean calcAxisAlignedBoundingBox(Model model, int x, int z, int y) {
        if (!ObjectDefinition.method345()) {
            ...
            if (Math.abs(var10) > var7 + RuneScript.anInt226) {
                return false;
            } else if (Math.abs(var11) > var15 + Class109.anInt1301) {
                return false;
            } else if (Math.abs(var12) > Class105.anInt1252 + var16) {
                return false;
            } else if (Math.abs(Class105.anInt1247 * var12 - var11 * ClientPreferences.anInt346) > Class109.anInt1301 * var16 + Class105.anInt1252 * var15) {
                return false;
            } else if (Math.abs(ClientPreferences.anInt346 * var10 - var12 * Class186.anInt2183) > Class105.anInt1252 * var7 + RuneScript.anInt226 * var16) {
                return false;
            } else {
