public abstract class Class6 {
    ...
    Class11[][][][] aClass11ArrayArrayArrayArray50;
    int anInt48;
    ...
    void method26(int var1, int var2, Buffer var3, int var4) {
        ...
        if (var7) {
            for (var8 = 0; var8 < var5; ++var8) {
                ...
                if (var9 != 0) {
                    Class11[] var12 = this.aClass11ArrayArrayArrayArray50[var8][var1][var2] = new Class11[var9];

                    for (var11 = 0; var11 < var9; ++var11) {
                        int var13 = var3.readSmart32();
                        int var14 = var3.readUnsignedByte();
                        var12[var11] = new Class11(var13, var14 >> 2, var14 & 3);
                    }
                }
            }
        }
